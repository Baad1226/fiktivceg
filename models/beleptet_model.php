...
class Beleptet_Model
{
	public function get_data($vars)
	{
		...
		try {
			...
			$sql = "select csaladi_nev, utonev, bejelentkezes, jogosultsag from felhasznalok where bejelentkezes='".$vars['login']."' and jelszo='".sha1($vars['password'])."'";
			...
			switch(count($felhasznalo)) {
				...
				case 1:
					$retData['eredmény'] = "OK";
					$retData['uzenet'] = "Üdvözöljük ".$felhasznalo[0]['csaladi_nev']." ".$felhasznalo[0]['utonev']."!<br><br>
